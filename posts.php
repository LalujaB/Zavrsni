...
$sql ="SELECT posts.id, posts.title, posts.body, posts.created_at, users.first_name, users.last_name FROM posts LEFT JOIN users ON posts.author = users.id ORDER BY posts.created_at DESC";
